...
public class UserModelValidationTest
{
    ...
    @Test
    public void shouldValidateUserModel() throws Exception
    {
        UserModel entity = new UserModel();
        entity.setEmail("ricky@hazelwood.id.au");
        entity.setFirstName("Ricky");
        entity.setLastName("Hazelwood");
        Set<ConstraintViolation<UserModel>> violations = validator.validate(entity);
        assertThat("Violations : " + violations, violations.isEmpty(), is(true));
    }
    ...
    {
        List<String> violations = getViolations(UserModel.class, property, value);
        assertThat("Violations : " + violations, violations.size(), is(expectedViolations.length));
